...
- « Pourquoi la marge d'exploitation de OPSCO a baissé de 2 points entre 2023 et 2024 ? »
...
- « Comment se positionne le ROE de DELTACO par rapport à la moyenne sectorielle du commerce de détail ? »
...
- **Formuler des questions précises** : plus le contexte est clair, plus la réponse est pertinente. Préférer « Quelle est l'évolution de la marge d'exploitation de OPSCO entre 2023 et 2024 ? » à « Parle-moi de OPSCO ».
...
- **Demander des recommandations** : l'assistant peut proposer des pistes d'action (« Que recommanderais-tu pour améliorer la trésorerie de DELTACO ? »).
